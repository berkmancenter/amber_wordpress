var amber = {
  ...
  translations : {
    en : {
      ...
      '<a class="amber-focus" href="{{CACHE}}">View the cache</a><div class="amber-iframe-container"><iframe sandbox="" src="{{LINK}}"/></div><a class="amber-original-link" href="{{LINK}}">Continue to the page</a></div><a class="amber-info" href="http://brk.mn/robustness" target="_blank">i</a></div>',
    ...
    fa : {    
        ...
        '<a class="amber-focus" href="{{CACHE}}">نمایش لینک های cache شده</a><div class="amber-iframe-container"><iframe sandbox="" src="{{LINK}}"/></div><a class="amber-original-link" href="{{LINK}}">نمایش لینک های فعال</a></div><a class="amber-info" href="http://brk.mn/robustness" target="_blank">i</a></div>',
        interstitial_html_down :
        '<div class="amber-interstitial"><a href="#" class="amber-close"></a><div class="amber-body"><div class="amber-status-text">این سایت ممکن است در دسترس</div><div class="amber-cache-text">{{NAME}} یک کش از {{DATE}}</div>' +
        '<a class="amber-focus" href="{{CACHE}}">نمایش لینک های cache شده</a><div class="amber-iframe-container"><iframe sandbox="" src="{{LINK}}"/></div><a class="amber-original-link" href="{{LINK}}">نمایش لینک های فعال</a></div><a class="amber-info" href="http://brk.mn/robustness" target="_blank">i</a></div>',
